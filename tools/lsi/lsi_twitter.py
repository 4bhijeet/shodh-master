...
if __name__ == '__main__':
	...
	for lang in langs:
		...
		corpus = MyCorpus('E:\\MS Sem 1\\IR\\ProjectPartC\\FilteredTweets\\language_combine\\twitter\\' + lang +'.json', lang)
		dictionary = create_dict('E:\\MS Sem 1\\IR\\ProjectPartC\\FilteredTweets\\language_combine\\twitter\\' + lang +'.json', lang)
		...
		for tp in topcs:
			print tp
		lsi.save('E:\\MS Sem 1\\IR\\ProjectPartC\\FilteredTweets\\language_combine\\twitter\\models\\'+lang+'.lsi')
		dictionary.save('E:\\MS Sem 1\\IR\\ProjectPartC\\FilteredTweets\\language_combine\\twitter\\models\\'+lang+'.dict')
		tfidf.save('E:\\MS Sem 1\\IR\\ProjectPartC\\FilteredTweets\\language_combine\\twitter\\models\\'+lang+'.tfidf')
		print 'Models saved in E:\\MS Sem 1\\IR\\ProjectPartC\\FilteredTweets\\language_combine\\twitter\\models\\'
	#topicModelling()